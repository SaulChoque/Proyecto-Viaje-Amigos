...
public class Principal {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException
	{
		...
		a2.paquetes[1].addTrasporte(new Terrestre("12:00","17:00",new Ubicacion("Terminal La paz","La paz"),new Ubicacion("Prov Illimani","La paz"),"bus Cama","haciento cama","4089 JKPO"),new Terrestre("20:00","03:00",new Ubicacion("Prov Illimani","Terminal La paz"),new Ubicacion("La paz","Terminal La paz"),"bus Cama","haciento cama","3045 JKPO"));
